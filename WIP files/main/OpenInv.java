...
public class OpenInv extends JavaPlugin implements IOpenInv {
    ...
    public void onEnable() {
        ...
        if (isSpigot && this.accessor.isSupported()) {
            ...
            this.setCommandExecutor(new CVaultGUI_Cmd(this), "cvault",);
            this.setCommandExecutor(new XVaultGUI_Cmd(this), "vault");
        } else {
            this.sendError(this.getLogger()::warning);
        }
    ...
    private void sendError(@NotNull Consumer<String> messageMethod) {
        if (!this.accessor.isSupported()) {
            messageMethod.accept("Command Register failed.");
        }
    }
